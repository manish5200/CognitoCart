...
@Component({
  selector: 'app-product-return-status',
  standalone: true,
  imports: [CommonModule],
  template: `
    <div *ngIf="isReturnable === true" class="status-badge returnable">
    ...
    <div *ngIf="isReturnable === false" class="status-badge non-returnable">
...
export class ProductReturnStatusComponent {
  @Input() isReturnable: boolean | undefined = undefined;
}
