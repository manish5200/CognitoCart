      ...
      <div class="auth-split">
        ...
        <div class="auth-brand-side fade-up">
          ...
          <div class="brand-content">
            ...
            <h2 class="brand-tagline">Intelligence meets Commerce.</h2>
            <p class="brand-desc">
              Join the next generation of e-commerce. Our AI analyzes millions of data points to bring you exactly what you're looking for, at the best price.
            </p>
            <div class="ai-stat-box">
              <span class="pulse-dot"></span> AI analyzed 10M+ products today
            </div>
          </div>
        </div>
        ...
        <div class="auth-form-side fade-up fade-up-delay-1">
          <div class="auth-form-inner">
            ...
            <p class="auth-subtitle">Sign in to your intelligent workspace.</p>
            ...
            <p class="auth-switch">
              Don't have an account? <a routerLink="/register" class="auth-link font-bold">Create account</a>
            </p>
          </div>
        </div>
      </div>
  ...
  onSubmit() {
    ...
    this.auth.login(this.credentials).subscribe({
      next: () => {
        ...
        this.loading = false;
        // The auth service redirects to / so we don't strictly need to route here, but doing it for safety.
