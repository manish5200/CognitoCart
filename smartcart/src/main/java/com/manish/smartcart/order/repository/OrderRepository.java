...
import com.manish.smartcart.seller.dto.SellerProductQualityDTO;
...
public interface OrderRepository extends JpaRepository<Order, Long> {
     ...
     */
    @Query("SELECT new com.manish.smartcart.admin.dto.DailyRevenueDTO(CAST(o.orderDate AS date), SUM(o.totalAmount)) " +
            "FROM Order o " +
     ...
     */
    @Query("SELECT new com.manish.smartcart.admin.dto.CategoryRevenueDTO(" +
     ...
     */
    @Query("SELECT new com.manish.smartcart.admin.dto.CustomerCLVDTO(" +
     ...
     */
    @Query("SELECT new com.manish.smartcart.admin.dto.CustomerChurnRiskDTO(" +
     ...
     */
    @Query("SELECT new com.manish.smartcart.seller.dto.SellerProductQualityDTO(" +
